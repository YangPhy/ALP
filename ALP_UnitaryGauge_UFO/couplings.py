...
GC_9 = Coupling(name = 'GC_9',
                value = '2*cw**2*complex(0,1)*gALPB',
                order = {'NP':1,'NPB':1})
...
GC_13 = Coupling(name = 'GC_13',
                 value = '2*cw**2*complex(0,1)*gALPW',
                 order = {'NP':1,'NPW':1})

GC_14 = Coupling(name = 'GC_14',
                 value = '-4*ee*complex(0,1)*gALPW',
                 order = {'NP':1,'NPW':1,'QED':1})
...
GC_28 = Coupling(name = 'GC_28',
                 value = '-2*cw*complex(0,1)*gALPB*sw',
                 order = {'NP':1,'NPB':1})

GC_29 = Coupling(name = 'GC_29',
                 value = '2*cw*complex(0,1)*gALPW*sw',
                 order = {'NP':1,'NPW':1})

GC_30 = Coupling(name = 'GC_30',
                 value = '2*complex(0,1)*gALPB*sw**2',
                 order = {'NP':1,'NPB':1})

GC_31 = Coupling(name = 'GC_31',
                 value = '2*complex(0,1)*gALPW*sw**2',
                 order = {'NP':1,'NPW':1})
