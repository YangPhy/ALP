...
Decay_ALP = Decay(name = 'Decay_ALP',
                  particle = P.ALP,
                  partial_widths = {(P.a,P.a):'(MALP**2*(8*cw**4*gALPB**2*MALP**4 + 16*cw**2*gALPB*gALPW*MALP**4*sw**2 + 8*gALPW**2*MALP**4*sw**4))/(32.*cmath.pi*abs(MALP)**3)',
                                    (P.a,P.Z):'((MALP**2 - MZ**2)*(8*cw**2*gALPB**2*MALP**4*sw**2 - 16*cw**2*gALPB*gALPW*MALP**4*sw**2 + 8*cw**2*gALPW**2*MALP**4*sw**2 - 16*cw**2*gALPB**2*MALP**2*MZ**2*sw**2 + 32*cw**2*gALPB*gALPW*MALP**2*MZ**2*sw**2 - 16*cw**2*gALPW**2*MALP**2*MZ**2*sw**2 + 8*cw**2*gALPB**2*MZ**4*sw**2 - 16*cw**2*gALPB*gALPW*MZ**4*sw**2 + 8*cw**2*gALPW**2*MZ**4*sw**2))/(16.*cmath.pi*abs(MALP)**3)',
                                    (P.g,P.g):'(2*gALPG**2*MALP**6)/(cmath.pi*abs(MALP)**3)',
                                    (P.W__minus__,P.W__plus__):'((8*gALPW**2*MALP**4 - 32*gALPW**2*MALP**2*MW**2)*cmath.sqrt(MALP**4 - 4*MALP**2*MW**2))/(16.*cmath.pi*abs(MALP)**3)',
                                    (P.Z,P.Z):'((8*cw**4*gALPW**2*MALP**4 - 32*cw**4*gALPW**2*MALP**2*MZ**2 + 16*cw**2*gALPB*gALPW*MALP**4*sw**2 - 64*cw**2*gALPB*gALPW*MALP**2*MZ**2*sw**2 + 8*gALPB**2*MALP**4*sw**4 - 32*gALPB**2*MALP**2*MZ**2*sw**4)*cmath.sqrt(MALP**4 - 4*MALP**2*MZ**2))/(32.*cmath.pi*abs(MALP)**3)'})
...
Decay_Z = Decay(name = 'Decay_Z',
                particle = P.Z,
                partial_widths = {(P.a,P.ALP):'((-MALP**2 + MZ**2)*(8*cw**2*gALPB**2*MALP**4*sw**2 - 16*cw**2*gALPB*gALPW*MALP**4*sw**2 + 8*cw**2*gALPW**2*MALP**4*sw**2 - 16*cw**2*gALPB**2*MALP**2*MZ**2*sw**2 + 32*cw**2*gALPB*gALPW*MALP**2*MZ**2*sw**2 - 16*cw**2*gALPW**2*MALP**2*MZ**2*sw**2 + 8*cw**2*gALPB**2*MZ**4*sw**2 - 16*cw**2*gALPB*gALPW*MZ**4*sw**2 + 8*cw**2*gALPW**2*MZ**4*sw**2))/(48.*cmath.pi*abs(MZ)**3)',
